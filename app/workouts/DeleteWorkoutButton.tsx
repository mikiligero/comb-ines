...
import { deleteWorkoutSession } from "@/app/actions";
...
export default function DeleteWorkoutButton({ workoutId }: { workoutId: number }) {
    ...
    return (
        <button
            ...
            className="w-10 h-10 rounded-xl bg-zinc-800/80 hover:bg-red-500/20 text-zinc-500 hover:text-red-400 flex items-center justify-center transition-colors shrink-0"
        >
            <Trash2 size={18} />
        </button>
    );
